...
public class PlayerAnimationData
{
    ...
    [SerializeField] private string uc_Turn_LeftParameterName = "UC_Turn_Left";
    [SerializeField] private string uc_Turn_RightParameterName = "UC_Turn_Right";
    ...
    public int UC_Turn_LeftParameterHash { get; private set; }
    public int UC_Turn_RightParameterHash { get; private set; }
    ...
    public void Initialize()
    {
        ...
        UC_Turn_LeftParameterHash = Animator.StringToHash(uc_Turn_LeftParameterName);
        UC_Turn_RightParameterHash = Animator.StringToHash(uc_Turn_RightParameterName);
